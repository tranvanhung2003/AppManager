...
import com.example.appmanager.activity.MainActivity;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    private void showNotification(String title, String body) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(channelId, "app_ban_thuoc", NotificationManager.IMPORTANCE_HIGH);
